...
def main():
    ...
    if choice == 'Create':
        ...
        name = st.text_input('Név', value='', max_chars=50, help='Írd be a nevet', key='name_input', encoding='utf-8')
        ...
        new_name = st.text_input('Új név', value='', max_chars=50, help='Írd be az új nevet', key='new_name_input', encoding='utf-8')
